...
const TimelinePage: React.FC<TimelinePageProps> = ({ daySchedule }) => {
    ...
    <div className="relative min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 py-[24px] MobileScreen:py-[12px]">
        ...
        <div>
          <div
            id="timeline"
            className="flex flex-col items-center justify-center lg:mx-[8.68%] TabletScreen:mx-[3.5%] md:my-[10rem] my-[8rem] min-h-screen py-2 text-hackathone-font-rocket-red"
          >
            <Typography
              variant="h3"
              component="h1"
              className="text-4xl font-bold mb-10 MobileScreen:text-center MobileScreen:text-[30.99px] MobileScreen:leading-[34.62px] md:text-[32.99px]"
            >
                ...
                >
                  ...
                  <TimelineSeparator>
                    ...
                    {index < daySchedule.day.length - 1 && (
                      <TimelineConnector className="transition-all duration-500 ease-in-out TabletScreen:hidden MobileScreen:hidden" />
                    )}
                  </TimelineSeparator>
                  <TimelineContent>
                    <Paper
