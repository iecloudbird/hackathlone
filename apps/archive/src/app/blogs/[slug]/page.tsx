...
import BlogPage from "./BlogPage"; // Client Component
...
const blogs: Blog[] = [
  ...
  },
  {
    ...
    points: [
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-1">
        Step 1: Visit the SpaceApps Website
      </strong>,
      <span key="item-2">
        {"\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0"}First things first,
        open your web browser and head over to the official SpaceApps Challenge
        website. You can do this by typing 'SpaceApps Challenge' into your
        preferred search engine or by directly entering the URL:{" "}
        <a
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-4">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-5">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-6">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-7">
        Step 5: Sign Up
      </strong>,
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-8">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-9">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-10">
  ...
  },
  {
    ...
    points: [
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-2">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-3">
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-11">
  ...
  },
  {
    ...
    points: [
      ...
      <strong key="item-2">1. Challenge Domains:</strong>,
      ...
      <strong key="item-3">2. Selection of Top Teams</strong>,
      ...
      <strong key="item-4">3. Choosing the Winners</strong>,
      ...
      <strong key="item-6">• Impact</strong>,
      ...
      <strong key="item-7">• Creativity</strong>,
      ...
      <strong key="item-8">• Validity</strong>,
      ...
      <strong key="item-9">• Relevance</strong>,
      ...
      <strong key="item-10">• Presentation</strong>,
    ...
    points: [
      ...
      >
        <tbody key="item-3-body">
          ...
          <tr key="item-3-2">
            <td className="border border-gray-700 p-4" key="item-3-2-1">
              Galway to Athlone
            </td>
            <td className="border border-gray-700 p-4" key="item-3-2-2">
              Use the 706/706X (Timetable).
            </td>
          </tr>
          <tr key="item-3-3">
            <td className="border border-gray-700 p-4" key="item-3-3-1">
              Limerick to Athlone
            </td>
            <td className="border border-gray-700 p-4" key="item-3-3-2">
              The Route 72 (Timetable) is available.
            </td>
          </tr>
          <tr key="item-3-4">
            <td className="border border-gray-700 p-4" key="item-3-4-1">
              Cork to Athlone
            </td>
            <td className="border border-gray-700 p-4" key="item-3-4-2">
      ...
      >
        <tbody>
          <tr key="item-5-1">
            <td className="border border-gray-700 p-4" key="item-5-1-1">
              From Major Cities
            </td>
            <td className="border border-gray-700 p-4" key="item-5-1-2">
              Irish Rail offers train services to Athlone from cities like
              Dublin, Limerick, and Galway.
            </td>
          </tr>
          <tr key="item-5-2">
            <td className="border border-gray-700 p-4" key="item-5-2-1">
              Booking
            </td>
            <td className="border border-gray-700 p-4" key="item-5-2-2">
          ...
          <tr key="item-5-3">
            <td className="border border-gray-700 p-4" key="item-5-3-1">
              From the Train Station
            </td>
            <td className="border border-gray-700 p-4" key="item-5-3-2">
              The station is approximately 3 kilometers from TU Shannon’s
              engineering building. Consider taking a cab or bus (Route ATH1 or
              A1) from the station to the venue.
            </td>
          </tr>
        </tbody>
      </table>,
  ...
  },
  {
    ...
    points: [
      ...
      <strong className="text-hackathone-font-rocket-red" key="item-1">
        The SpaceApps Hackathon 2024 presents a wide array of challenges spread
