    ...
    <>
      <div className="p-4 ">
        <div className="hidden md:block max-w-6xl mx-auto m-4">
          <h1 className="text-left text-6xl font-bold text-hackathone-font-rocket-red text-left p-4">
            Blogs
          </h1>
        ...
        <div className=" block lg:hidden max-w-6xl mx-auto m-16 flex flex-col ">
          <h1 className="text-left text-6xl font-bold text-hackathone-font-rocket-red text-center p-4">
            Blogs
          </h1>
