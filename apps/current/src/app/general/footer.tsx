...
const Footer = () => {
  ...
  return (
    <footer className="py-4 flex flex-col gap-4 text-[#F6F4F4] text-sm font-firaSans">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-4 px-4 sm:px-[5%] py-2">
        ...
        <div className="flex flex-col items-center gap-6 lg:gap-12 w-full lg:w-auto">
          ...
          <div className="flex gap-3 items-center lg:gap-4">
            ...
            >
              <Image
                className="hover:scale-110 w-4 sm:w-6 h-4 sm:h-6"
                src={XIcon}
                height={80}
                width={80}
                alt="X Icon"
          ...
          <hr className="w-full lg:hidden my-6" />
        </div>

        {/* Links Sections */}
        <div className="flex flex-cols-2 lg:flex lg:flex-row lg:items-start w-full gap-6 lg:gap-16 justify-evenly">
          <div className="lg:mt-4">
            <h3 className="font-overpass font-bold text-xl text-hackathone-font-rocket-red mb-2 lg:mb-4">
              Participation Kit
            </h3>
          ...
          <div className="lg:mt-4">
            ...
            <ul className="list-none leading-relaxed">
              ...
              <li className="my-2">
                <a
                  className="no-underline text-[#f6f4f4] hover:text-hackathone-font-rocket-red"
                  href="#"
                  rel="noreferrer"
                >
                  Opening Ceremony
          ...
          <div className="lg:mt-4 hidden sm:block">
            <h3 className="font-overpass font-bold text-xl text-hackathone-font-rocket-red mb-2 lg:mb-4">
              Space Apps UL’21
            </h3>
            <ul className="list-none leading-relaxed">
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-[5%] py-3">
